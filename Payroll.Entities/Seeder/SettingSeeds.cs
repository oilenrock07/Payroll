...
{
    public class SettingSeeds : ISeeders
    {
        public IEnumerable<Setting> GetDefaultSeeds()
        {
            return new List<Setting>()
            {
                ...
                new Setting { SettingKey = "APP_EMPLOYEE_IMAGE_PATH", Value = "~/Images/Employee/", Description = "Relative image path of the employee's pictures", Category = "APP" },
